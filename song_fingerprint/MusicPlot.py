...
try:
    with open("totalMatches_database.p", "rb" ) as f:
        totalMatches_database = pickle.load(f)
except:
    totalMatches_database = {}

try:
    with open("songLength_database.p", "rb" ) as f:
        songLength_database = pickle.load(f)
except:
    songLength_database = {}
...
def save():
    with open("song_database.p", "wb" ) as f:
        song_database = pickle.dump(song_database,f)

    with open("totalMatches_database.p", "wb" ) as f:
        totalMatches_database = pickle.dump(totalMatches_database, f)

    with open("songLength_database.p", "wb" ) as f:
        songLength_database = pickle.dump(songLength_database, f)
